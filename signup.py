...
def connect_database():
    if emailEntry.get()=='' or usernameEntry.get()=='' or passwordEntry.get()=='' or confirmEntry.get()=='':
        ...
        try:
            con=pymysql.connect(host='localhost',user='tushar',password='1234')
            mycursor=con.cursor()
        except:
...
signup_window.geometry('990x660+50+30')
...
check=IntVar()
termsandconditions=Checkbutton(frame,text='I agree to the Terms & Conditions',font=('Microsoft Yahei UI Light',9,'bold'),fg='firebrick1',
                               bg='white',activebackground='white',activeforeground='firebrick1',cursor='hand2',variable=check)
